...
public class BlockSieve{
  ...
  private abstract class Node{
    ...
    public int add(long label, VertexSet value){
      return add(label, value, value.cardinality());
    }

    public int add(long label, VertexSet value, int cardinality){
      int i = add(label);
    ...
    public abstract void filterSuperblocks(long[] longs, long[] neighbors, 
        int intersects, ArrayList< VertexSet > list);
  ...
  public VertexSet put(VertexSet bs, VertexSet value){
  ...
  private Node newPath(int index, long[] longs, VertexSet value){
  ...
  public void collectSuperblocks(
      VertexSet component, VertexSet neighbors, ArrayList< VertexSet > list){
